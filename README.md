...
```
L7  PRESENTATION    barrister burgundy + deed cream (Open Design)
L6  ORCHESTRATION   Hermes sub-context (Kimi K2.6 / DeepSeek V3.5 / local)
L5  DOMAIN MCP      landlaw-ai-mcp, legal-document-ai-mcp, contract-review-ai-mcp
L4  AGENT MEMORY    agentmemory (v0.9.26) — isolated mode
L3  KNOWLEDGE GRAPH Cognee subgraph — scope: UK property law, conveyancing, leases, planning, case citations
L2  VERSIONED HIST  Memoria (v0.4.0) — namespace "landlaw"
...
```bash
git clone https://github.com/CSOAI-ORG/landlaw-hive
cd landlaw-hive
...
`https://landlaw.ai/.well-known/agent-card.json` — see `agent-card.json`.
...
£199/mo solo → £999/mo firm. £47B legal tech market.
